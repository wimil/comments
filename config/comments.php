...
return [
    ...
    |--------------------------------------------------------------------------
    | If you create another kind of comment with the extension of this, you should      
    | update this field with that.
    |
    */
    ...
    |--------------------------------------------------------------------------
    | You can add. * At the beginning or end of a word or phrase so that more words    
    | are found. Examples:
    |
    ...
    */
    ...
    | - Comments that do not contain blacklisted words will be public. Otherwise, they  
    | will remain hidden
    |
    | Mode => 3 (Close)
    | - Comments will be created that do not contain blacklisted words. Otherwise, they 
    | will not be created
    |
    */
    ...
    */
    ...
    | UrlLinker
    |--------------------------------------------------------------------------
    | UrlLinker is a PHP module for converting plain text snippets to HTML, and any web 
    | addresses in the text into HTML hyperlinks.
    */
    'urlLinker' => [
        'enable' => true,
        'config' => [
